...
export default function ShowcaseSection() {
  ...
  function closeModal() {
    ...
    tl.to(panel, { opacity: 0, scale: 0.96, duration: 0.2, ease: "power2.in" }, 0);
    ...
    <section id="showcase" className="bg-ink py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center">
          <p className="font-mono text-xs uppercase tracking-[0.2em] text-paper/40">Gallery</p>
          <h2 className="mt-2 font-heading text-xl font-semibold tracking-normal text-paper sm:text-2xl">
            Pagzly로 만든 상세페이지
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-paper/60">
            Pexels 상품 사진으로 실제 생성한 예시입니다. 클릭하면 크게 볼 수 있어요.
          </p>
        </div>
              ...
              >
                ...
                <div className="flex items-center justify-between border-t border-line px-4 py-3">
                  <div>
                    ...
                    <h3 className="mt-0.5 font-heading text-lg font-bold text-ink">{item.name}</h3>
                  </div>
